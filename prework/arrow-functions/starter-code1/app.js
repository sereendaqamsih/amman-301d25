...
const sum1 = (a, b, c, d) => { return a + b + c + d;};
...
const sumAndProduct1 = (a,b) => { let sum = a + b;
  let product = a * b;
  return [sum, product];};
...
const message1 = (name) => { return `Hello, ${name}!`;};
...
let joe1 = new Student1 ('Joe', 'Schmoe', 100);
console.log(joe1);*/
...
// TODO: After viewing the previous console.log(), return the code to a working state.
/*const greeting1 = () => {return `Hi, my name is ${this.name}`;};
...
/*const courseName1= () => {  return 'This student is enrolled in Code 301.';
};
...
// joe parameter in line 167
// 2. What is "this" when joe.scopeArrow() is invoked?
//value of this in their lexical scope.
